...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="${pageContext.request.contextPath }/queryAllUser">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${pager.dates }" varStatus="status">
					<tr>
						<td>
			...
			<input type="hidden" id="totalPageCount" value="${pager.totalPage}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${pager.totalRow}"/>
